    ...
    <div className="p-6 hover:bg-gray-50 transition-colors group">
      <div className="flex items-start gap-4">
        ...
        <button onClick={toggleComplete} disabled={loading} className="flex-shrink-0 mt-1">
          <div
            className={`w-5 h-5 rounded border-2 flex items-center justify-center transition-all ${todo.completed ? "bg-green-500 border-green-500" : "border-gray-300 hover:border-green-400"
              }`}
          >
            {todo.completed && (
        ...
        <div className="flex-1 min-w-0">
          <h3
            className={`text-base font-medium transition-all ${todo.completed ? "text-gray-500 line-through" : "text-gray-900"
              }`}
          >
            {todo.title}
          </h3>
